...
export const env = {
  ...
  AUTH_RATE_LIMIT_MAX: Number.isFinite(authRateLimitMax) && authRateLimitMax > 0 ? authRateLimitMax : 10,
  JWT_SECRET: jwtSecret,
  JWT_EXPIRES_IN: value('JWT_EXPIRES_IN', '1h'),
  JWT_ISSUER: requiredInProduction('JWT_ISSUER', IS_PRODUCTION ? '' : 'awk-video-editor-api'),
  JWT_AUDIENCE: requiredInProduction('JWT_AUDIENCE', IS_PRODUCTION ? '' : 'awk-video-editor-client'),
